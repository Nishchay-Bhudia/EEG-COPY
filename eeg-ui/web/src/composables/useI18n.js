...
const I18N = {
  en: {
    ...
    navClients: 'Clients',
    navReplay: 'Replay',
    navSwaraCalendar: 'Swar Calendar',
    navAnalyze: 'Analyze',
    ...
    // ── Vue-only: Home ("This Week" dashboard) ──
    greetingMorning: 'Good morning',
    greetingAfternoon: 'Good afternoon',
    greetingEvening: 'Good evening',
    heroSubSuffix: ' · your week at a glance',
    beginSittingBtn: 'Begin a sitting',
    watchLiveBtn: 'Watch live',
    activeThisWeekTemplate: '{n} active this week',
    followUpSoon: 'follow up soon',
    allOnTrack: 'all on track',
    allTimeTemplate: '{n} all-time',
    kpiPracticeThisWeek: 'Practice this week',
    kpiAvgSessionLabel: 'Avg session',
    kpiLastSessionLabel: 'Last session',
    overSittingsTemplate: 'over {n} sitting{s}',
    minAgoTemplate: '{n}m ago',
    hourAgoTemplate: '{n}h ago',
    dayAgoTemplate: '{n}d ago',
    lastSeenPrefix: 'last seen ',
    noRecentSessionChip: 'No recent session',
    hrTemplate: '{h}h',
    hrMinTemplate: '{h}h {m}m',
    minTemplate: '{m}m',
    secTemplate: '{s}s',

    // ── Vue-only: Practices (superadmin activity-type CRUD) ──
    practicesTitle: 'Practices',
    practicesSub: 'The vocabulary of contemplative practices offered when starting a sitting (superadmin only).',
    addPracticeTitle: 'ADD PRACTICE',
    practiceNamePlaceholder: 'e.g. Vipassanā, Kīrtan, Breath-count…',
    addingEllipsis: 'Adding…',
    add: 'Add',
    addPracticeHint: "New practices appear at the bottom of the picker. Reorder with the arrows; archive to hide one from the picker without losing past sessions' labels.",
    allPracticesTitle: 'ALL PRACTICES',
    couldNotLoadPractices: 'Could not load practices: ',
    noPracticesYetHint: 'No practices yet. Add the first above.',
    ...
    archiveBtn: 'Archive',
    deleteBtn: 'Delete',
    confirmDeletePracticeTemplate: 'Delete practice "{name}"? Existing sessions keep their label; it just leaves the picker.',

    // ── Vue-only: Users (superadmin account management) ──
    usersTitle: 'Users',
    usersSub: 'Provision instructors and manage every account (superadmin only).',
    roleStudentOption: 'Student (user)',
    roleInstructorOption: 'Instructor (co-admin)',
    roleSuperadminOption: 'Superadmin (admin)',
    roleStudent: 'Student',
    ...
    createBtn: 'Create',
    createAccountHint: 'Instructors (co-admin) manage their own clients and student logins; students (user) only sign in and sit. Creating a student here also adds a linked client record to your cohort.',
    ...
    newPasswordMin6Placeholder: 'New password (min 6)',
    savingEllipsis: 'Saving…',
    atLeast6Chars: 'At least 6 characters.',
    passwordSetDone: '✓ Password set',
    resetPasswordBtn: 'Reset password',
    cannotDeleteOwnAccount: 'You cannot delete your own account',
    deleteAccountTitle: 'Delete account',
    confirmDeleteAccountTemplate: 'Delete account "{name}"? This cannot be undone.',

    // ── Vue-only: Swar Calendar (Shiva Svarodaya breath calendar) ──
    swaraGateTitle: 'Align with the Sun',
    swaraGateDesc: 'The Swar Calendar needs your precise location to anchor its calculations to your local sunrise and lunar phase. Everything is computed locally on your device — no location data is sent anywhere.',
    swaraCalibrateBtn: 'Calibrate Instrument',
    swaraAcquiring: 'Acquiring coordinates…',
    swaraManualTitle: 'Manual Calibration',
    swaraManualDefaultHint: 'Enter your coordinates to proceed.',
    swaraLatitude: 'Latitude',
    swaraLongitude: 'Longitude',
    swaraSetLocationBtn: 'Set Location',
    swaraCalibratingCycles: 'Calibrating cycles…',
    swaraTodaysCycle: "Today's Cycle",
    swaraCalibratedLocation: 'Calibrated location',
    swaraDominantChannel: 'DOMINANT CHANNEL',
    swaraLeftIda: 'Left (Ida)',
    swaraRightPingala: 'Right (Pingala)',
    swaraSushumnaCentral: 'Sushumna (Central)',
    swaraNoteLeft: 'Cooling, lunar energy. Favorable for stable, enduring tasks, arts, and calm interaction.',
    swaraNoteRight: 'Heating, solar energy. Favorable for active, physical tasks, consumption, and intense exertion.',
    swaraNoteSushumnaState: 'Transitional energy. Favorable only for meditation and stillness; unfavorable for worldly actions.',
    swaraUntilPhaseStarts: 'until phase starts',
    swaraUntilTransition: 'until transition',
    swaraLunarPhase: 'LUNAR PHASE',
    swaraShuklaPaksha: 'Shukla Paksha',
    swaraKrishnaPaksha: 'Krishna Paksha',
    swaraTithiTemplate: 'Tithi {n}',
    swaraSeasonalContext: 'SEASONAL CONTEXT',
    swaraSeasonCold: 'Cold / high-latitude',
    swaraSeasonHot: 'Hot / equatorial',
    swaraSeasonTemperate: 'Temperate',
    swaraSeasonTextCold: 'Apas & Prithvi Tattvas linger longer. The breath naturally seeks to ground and warm the body.',
    swaraSeasonTextHot: 'Agni Tattva is dominant. The system naturally seeks cooling lunar flows.',
    swaraSeasonTextTemperate: 'The elements flow in equilibrium without extreme seasonal dominance.',
    swaraAlignmentCheck: 'ALIGNMENT CHECK',
    swaraStreakTemplate: 'Streak: {n} {day}',
    swaraDaySingular: 'day',
    swaraDayPlural: 'days',
    swaraArishtaTitle: 'Arishta Warning',
    swaraArishtaDesc: 'Three or more consecutive days of misalignment detected. The scripture warns this indicates energetic disturbance. Consider manual breath-forcing techniques to correct the flow.',
    swaraLogCompleted: 'Log completed for today',
    swaraObservedTemplate: 'Observed: {nostril} ({status})',
    swaraAligned: 'Aligned',
    swaraMisaligned: 'Misaligned',
    swaraLogHint: 'Which nostril is currently flowing more freely? Check now to record your alignment.',
    swaraLeftFlowBtn: '← Left Flow',
    swaraRightFlowBtn: 'Right Flow →',
    swaraTravelTitle: 'TRAVEL GUIDANCE (DESHA-VICHARA)',
    swaraTravelHint: 'Select your departure direction to check alignment.',
    swaraDirNorth: 'north',
    swaraDirSouth: 'south',
    swaraDirEast: 'east',
    swaraDirWest: 'west',
    swaraRequiredDominance: 'Required dominance',
    swaraFavorableNow: 'Is it favorable now?',
    swaraYes: 'Yes',
    swaraNo: 'No',
    swaraNextFavorableWindow: 'Next favorable window',
    swaraDailySchedule: 'DAILY SCHEDULE',
    swaraSunriseToSunrise: 'From sunrise to sunrise',
    swaraFlowTemplate: '{nostril} flow',
    swaraLeftWord: 'left',
    swaraRightWord: 'right',
    swaraSushumnaWord: 'Sushumna',
    swaraLocationUnavailable: 'This browser does not support location detection. Enter your coordinates manually.',
    swaraLocationDenied: 'Location permission was denied. Enter your coordinates manually to continue.',
    swaraLocationError: 'Could not determine your location. Enter your coordinates manually to continue.',
    swaraYourLocation: 'Your location',
    swaraManualEntry: 'Manual entry',
  },
  ...
  gu: {
    ...
    navClients: 'ગ્રાહકો',
    navReplay: 'રિપ્લે',
    navSwaraCalendar: 'સ્વર કેલેન્ડર',
    navAnalyze: 'વિશ્લેષણ',
    navPrescribe: 'સૂચન',
    navAdmin: 'એડમિન',
    ...
    heroSubSuffix: ' · તમારું અઠવાડિયું એક નજરમાં',
    beginSittingBtn: 'સેશન શરૂ કરો',
    watchLiveBtn: 'લાઇવ જુઓ',
    activeThisWeekTemplate: '{n} આ અઠવાડિયે સક્રિય',
    followUpSoon: 'ટૂંક સમયમાં અનુસરો',
    allOnTrack: 'બધા ટ્રેક પર છે',
    allTimeTemplate: '{n} કુલ',
    kpiPracticeThisWeek: 'આ અઠવાડિયાની સાધના',
    kpiAvgSessionLabel: 'સરેરાશ સેશન',
    kpiLastSessionLabel: 'છેલ્લું સેશન',
    overSittingsTemplate: '{n} સેશન પર',
    minAgoTemplate: '{n} મિનિટ પહેલાં',
    hourAgoTemplate: '{n} કલાક પહેલાં',
    dayAgoTemplate: '{n} દિવસ પહેલાં',
    lastSeenPrefix: 'છેલ્લે જોયું: ',
    noRecentSessionChip: 'તાજેતરમાં કોઈ સેશન નથી',
    hrTemplate: '{h} કલાક',
    hrMinTemplate: '{h} કલાક {m} મિનિટ',
    minTemplate: '{m} મિનિટ',
    secTemplate: '{s} સેકન્ડ',

    practicesTitle: 'સાધનાઓ',
    practicesSub: 'સેશન શરૂ કરતી વખતે ઓફર કરવામાં આવતી ચિંતનશીલ સાધનાઓની શબ્દાવલિ (ફક્ત સુપરએડમિન).',
    addPracticeTitle: 'સાધના ઉમેરો',
    practiceNamePlaceholder: 'દા.ત. વિપશ્યના, કીર્તન, શ્વાસ-ગણતરી…',
    addingEllipsis: 'ઉમેરી રહ્યાં છીએ…',
    add: 'ઉમેરો',
    addPracticeHint: 'નવી સાધનાઓ પિકરના તળિયે દેખાય છે. તીર વડે ક્રમ બદલો; પિકરમાંથી છુપાવવા માટે આર્કાઇવ કરો, ભૂતકાળના સેશનના લેબલ ગુમાવ્યા વિના.',
    allPracticesTitle: 'બધી સાધનાઓ',
    couldNotLoadPractices: 'સાધનાઓ લોડ કરી શકાઈ નથી: ',
    noPracticesYetHint: 'હજી કોઈ સાધના નથી. ઉપર પ્રથમ ઉમેરો.',
    practiceNameRequired: 'સાધનાનું નામ જરૂરી છે.',
    nameRequired: 'નામ જરૂરી છે.',
    moveUpTitle: 'ઉપર ખસેડો',
    moveDownTitle: 'નીચે ખસેડો',
    archivedBadge: 'આર્કાઇવ થયેલ',
    saveBtn: 'સાચવો',
    cancelBtn: 'રદ કરો',
    renameBtn: 'નામ બદલો',
    restoreBtn: 'પુનઃસ્થાપિત કરો',
    archiveBtn: 'આર્કાઇવ કરો',
    deleteBtn: 'કાઢી નાખો',
    confirmDeletePracticeTemplate: 'સાધના "{name}" કાઢી નાખવી છે? હાલના સેશન તેમનું લેબલ જાળવી રાખશે; તે ફક્ત પિકરમાંથી દૂર થશે.',

    usersTitle: 'વપરાશકર્તાઓ',
    usersSub: 'શિક્ષકોને પ્રોવિઝન કરો અને દરેક ખાતું સંચાલિત કરો (ફક્ત સુપરએડમિન).',
    roleStudentOption: 'વિદ્યાર્થી (user)',
    roleInstructorOption: 'શિક્ષક (co-admin)',
    roleSuperadminOption: 'સુપરએડમિન (admin)',
    roleStudent: 'વિદ્યાર્થી',
    roleInstructor: 'શિક્ષક',
    roleSuperadmin: 'સુપરએડમિન',
    createAccountTitle: 'ખાતું બનાવો',
    creatingEllipsis: 'બનાવી રહ્યાં છીએ…',
    createBtn: 'બનાવો',
    createAccountHint: 'શિક્ષકો (co-admin) પોતાના ગ્રાહકો અને વિદ્યાર્થી લૉગિન સંચાલિત કરે છે; વિદ્યાર્થીઓ (user) ફક્ત સાઇન ઇન કરે છે અને બેસે છે. અહીં વિદ્યાર્થી બનાવવાથી તમારા જૂથમાં લિંક થયેલ ગ્રાહક રેકોર્ડ પણ ઉમેરાય છે.',
    allAccountsTitle: 'બધા ખાતાઓ',
    couldNotLoadUsers: 'વપરાશકર્તાઓ લોડ કરી શકાયા નથી: ',
    noAccountsYet: 'હજી કોઈ ખાતું નથી.',
    usernameRequired: 'વપરાશકર્તા નામ જરૂરી છે.',
    passwordMin6: 'પાસવર્ડ ઓછામાં ઓછા 6 અક્ષરનો હોવો જોઈએ.',
    createdPrefix: 'બનાવ્યું ',
    cannotChangeOwnRole: 'તમે તમારી પોતાની ભૂમિકા બદલી શકતા નથી',
    changeRoleTitle: 'ભૂમિકા બદલો',
    newPasswordMin6Placeholder: 'નવો પાસવર્ડ (ઓછામાં ઓછા 6)',
    savingEllipsis: 'સાચવી રહ્યાં છીએ…',
    atLeast6Chars: 'ઓછામાં ઓછા 6 અક્ષર.',
    passwordSetDone: '✓ પાસવર્ડ સેટ થયો',
    resetPasswordBtn: 'પાસવર્ડ રીસેટ કરો',
    cannotDeleteOwnAccount: 'તમે તમારું પોતાનું ખાતું કાઢી શકતા નથી',
    deleteAccountTitle: 'ખાતું કાઢી નાખો',
    confirmDeleteAccountTemplate: 'ખાતું "{name}" કાઢી નાખવું છે? આ પૂર્વવત્ કરી શકાશે નહીં.',

    swaraGateTitle: 'સૂર્ય સાથે તાલમેલ',
    swaraGateDesc: 'સ્વર કેલેન્ડરને તમારા સ્થાનિક સૂર્યોદય અને ચંદ્ર તબક્કા સાથે તેની ગણતરીઓને જોડવા માટે તમારા ચોક્કસ સ્થાનની જરૂર છે. બધું તમારા ડિવાઇસ પર જ સ્થાનિક રીતે ગણવામાં આવે છે — કોઈ સ્થાન ડેટા ક્યાંય મોકલવામાં આવતો નથી.',
    swaraCalibrateBtn: 'સાધન માપાંકિત કરો',
    swaraAcquiring: 'સ્થાનાંક મેળવી રહ્યાં છીએ…',
    swaraManualTitle: 'મેન્યુઅલ માપાંકન',
    swaraManualDefaultHint: 'આગળ વધવા માટે તમારા સ્થાનાંક દાખલ કરો.',
    swaraLatitude: 'અક્ષાંશ',
    swaraLongitude: 'રેખાંશ',
    swaraSetLocationBtn: 'સ્થાન સેટ કરો',
    swaraCalibratingCycles: 'ચક્ર માપાંકિત કરી રહ્યાં છીએ…',
    swaraTodaysCycle: 'આજનું ચક્ર',
    swaraCalibratedLocation: 'માપાંકિત સ્થાન',
    swaraDominantChannel: 'મુખ્ય નાડી',
    swaraLeftIda: 'ડાબી (ઇડા)',
    swaraRightPingala: 'જમણી (પિંગલા)',
    swaraSushumnaCentral: 'સુષુમ્ણા (મધ્ય)',
    swaraNoteLeft: 'શીતળ, ચંદ્ર ઊર્જા. સ્થિર, લાંબા ગાળાના કાર્યો, કળા અને શાંત વાર્તાલાપ માટે અનુકૂળ.',
    swaraNoteRight: 'ઉષ્ણ, સૂર્ય ઊર્જા. સક્રિય, શારીરિક કાર્યો, ભોજન અને તીવ્ર પરિશ્રમ માટે અનુકૂળ.',
    swaraNoteSushumnaState: 'સંક્રમણશીલ ઊર્જા. ફક્ત ધ્યાન અને સ્થિરતા માટે અનુકૂળ; સાંસારિક કાર્યો માટે અનુકૂળ નથી.',
    swaraUntilPhaseStarts: 'તબક્કો શરૂ થાય ત્યાં સુધી',
    swaraUntilTransition: 'સંક્રમણ સુધી',
    swaraLunarPhase: 'ચંદ્ર તબક્કો',
    swaraShuklaPaksha: 'શુક્લ પક્ષ',
    swaraKrishnaPaksha: 'કૃષ્ણ પક્ષ',
    swaraTithiTemplate: 'તિથિ {n}',
    swaraSeasonalContext: 'ઋતુ સંદર્ભ',
    swaraSeasonCold: 'ઠંડું / ઉચ્ચ-અક્ષાંશ',
    swaraSeasonHot: 'ગરમ / વિષુવવૃત્તીય',
    swaraSeasonTemperate: 'સમશીતોષ્ણ',
    swaraSeasonTextCold: 'આપ (જળ) અને પૃથ્વી તત્ત્વો વધુ સમય રહે છે. શ્વાસ સ્વાભાવિક રીતે શરીરને સ્થિર અને ગરમ કરવા મથે છે.',
    swaraSeasonTextHot: 'અગ્નિ તત્ત્વ પ્રભાવી છે. તંત્ર સ્વાભાવિક રીતે શીતળ ચંદ્ર પ્રવાહો શોધે છે.',
    swaraSeasonTextTemperate: 'તત્ત્વો કોઈ પણ ઋતુગત પ્રભુત્વ વિના સંતુલનમાં વહે છે.',
    swaraAlignmentCheck: 'સંરેખણ તપાસ',
    swaraStreakTemplate: 'સિલસિલો: {n} {day}',
    swaraDaySingular: 'દિવસ',
    swaraDayPlural: 'દિવસ',
    swaraArishtaTitle: 'અરિષ્ટ ચેતવણી',
    swaraArishtaDesc: 'સતત ત્રણ કે વધુ દિવસ ખોટી ગોઠવણી જોવા મળી છે. શાસ્ત્ર ચેતવે છે કે આ ઊર્જાસભર વિક્ષેપ સૂચવે છે. પ્રવાહને સુધારવા માટે મેન્યુઅલ શ્વાસ-બળજબરી તકનીકોનો વિચાર કરો.',
    swaraLogCompleted: 'આજ માટે નોંધ પૂર્ણ થઈ',
    swaraObservedTemplate: 'અવલોકન: {nostril} ({status})',
    swaraAligned: 'સંરેખિત',
    swaraMisaligned: 'ખોટી રીતે ગોઠવાયેલ',
    swaraLogHint: 'હાલમાં કઈ નાડી વધુ મુક્ત રીતે વહી રહી છે? તમારું સંરેખણ નોંધવા માટે હમણાં તપાસો.',
    swaraLeftFlowBtn: '← ડાબો પ્રવાહ',
    swaraRightFlowBtn: 'જમણો પ્રવાહ →',
    swaraTravelTitle: 'મુસાફરી માર્ગદર્શન (દેશ-વિચાર)',
    swaraTravelHint: 'સંરેખણ તપાસવા માટે તમારી પ્રસ્થાન દિશા પસંદ કરો.',
    swaraDirNorth: 'ઉત્તર',
    swaraDirSouth: 'દક્ષિણ',
    swaraDirEast: 'પૂર્વ',
    swaraDirWest: 'પશ્ચિમ',
    swaraRequiredDominance: 'જરૂરી પ્રભુત્વ',
    swaraFavorableNow: 'શું તે અત્યારે અનુકૂળ છે?',
    swaraYes: 'હા',
    swaraNo: 'ના',
    swaraNextFavorableWindow: 'આગલી અનુકૂળ વિન્ડો',
    swaraDailySchedule: 'દૈનિક સમયપત્રક',
    swaraSunriseToSunrise: 'સૂર્યોદયથી સૂર્યોદય સુધી',
    swaraFlowTemplate: '{nostril} પ્રવાહ',
    swaraLeftWord: 'ડાબો',
    swaraRightWord: 'જમણો',
    swaraSushumnaWord: 'સુષુમ્ણા',
    swaraLocationUnavailable: 'આ બ્રાઉઝર સ્થાન શોધને સપોર્ટ કરતું નથી. કૃપા કરીને તમારા સ્થાનાંક જાતે દાખલ કરો.',
    swaraLocationDenied: 'સ્થાનની પરવાનગી નકારવામાં આવી. ચાલુ રાખવા માટે તમારા સ્થાનાંક જાતે દાખલ કરો.',
    swaraLocationError: 'તમારું સ્થાન નક્કી કરી શકાયું નથી. ચાલુ રાખવા માટે તમારા સ્થાનાંક જાતે દાખલ કરો.',
    swaraYourLocation: 'તમારું સ્થાન',
    swaraManualEntry: 'મેન્યુઅલ પ્રવેશ',
  },
};
